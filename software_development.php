...
<head>
    ...
    <!--====== Title ======-->
    <title>Best Software Development company| Software Provider Company in <?php echo $city; ?></title>
    <meta name="description" content="Camwel Microfinance Software Solution company is the best software provider company in Patna, Pune and Bangalore. We have 8+years experience in this field.">
    <meta name="keywords" content="software company, best software company, software development company, software company in Patna, best software company in Patna, software, company, best software provider company in Patna, Camwel , Camwel software provider company.">
...
<body>
    <div class="page-wrapper">
        ...
        <!-- Page Banner Start -->
        <section class="page-banner bgs-cover ovrlay pt-50" style="background-image: url(assets/images/more/software_image_1.png);">
            <div class="container">
        ...
        <section class="container" style="margin-top:64px;">
            <div class="row">
                <div class="col-md-12">
                    <h3> <span class="under_line">Software</span> Development Services</h3>
                    <p class="text-justify">Invent, build, integrate, scale and upgrade your applications with Camwel Solution LLP For more than three decades, Camwel Solution LLP has been harnessing digital technologies for the benefit of Fortune 700+ businesses, mid and large enterprises, and start-ups across the variety of industries. Fully in the art and science of software engineering and management, we help you to build high-quality software solutions and products as well as deliver a wide range of related professional services.</p>
                </div>
                <!-- <div class="col-md-6">
                    <img src="./assets/images/services/software.jpg" alt="">
                </div> -->
            </div>
        ...
        <section class="mt feature container">

            <div class="row" style="box-shadow: 6px 6px rgb(51, 49, 49,0.3); background-color:rgb(51, 49, 49,0.1); padding:30px;">
                
                <div class="col-md-8" style="padding:50px;">
                    <h3> <span class="under_line">WHAT</span> SERVICE ARE YOU LOOKING FOR?</h3>
                    <ul>
                        <li><i class="fa fa-hand-o-right"></i> <span class="bold">Complete Software Development:</span>Shouldering complete software development project <span style="padding-left:22px;">pipeline or its part to support your business growth</span></li>
                        <li><i class="fa fa-hand-o-right"></i> <span class="bold">Custom Software Development:- </span>Development of custom enterprise software solutions to  <span style="padding-left:22px;"> address the unique needs of your business.</li>
                        <li><i class="fa fa-hand-o-right"></i> <span class="bold">Software Product Development:-</span>Development of SaaS, mobile and desktop applications  <span style="padding-left:22px;"> for marketing and distributing to mass enterprise/consumer users.</li>
                        <li><i class="fa fa-hand-o-right"></i> <span class="bold">Software Consulting:-</span> A holistic set of consulting services for both new and ongoing  <span style="padding-left:22px;"> software development projects – from ideation and feasibility study to implementation  <span style="padding-left:22px;"> strategy.</li>
                        <li><i class="fa fa-hand-o-right"></i> <span class="bold">Software Support and Evolution:-</span>A broad set of services – help desk & support, cloud  <span style="padding-left:22px;"> migration, legacy re-engineering, and more – to keep your business-critical applications  <span style="padding-left:22px;"> healthy and stable.</li>
                        <li><i class="fa fa-hand-o-right"></i> <span class="bold">Development team augmentation:-</span>More than 700 IT specialist to help you handle the  <span style="padding-left:22px;"> lack of your internal resources and capabilities.</li>


                    </ul>
                </div>
                <div class="col-md-4" style="margin-top:75px;">
                    <img src="assets/images/services/services.png" alt="">
                </div>
            </div>
        ...
        <section class="container" style="margin-top:55px;">
            <h3> <span class="under_line">Why</span> Camwel?</h3>
            <ul>
                <li><i class="fa fa-check"></i> One-stop shop for end-to-end software development.</li>
                <li><i class="fa fa-check"></i> Over 50+ IT Professionals on board, and the partner network of 5 companies with 700 employees.</li>
                <li><i class="fa fa-check"></i> More than 50% of the developers are of senior level.</li>
                <li><i class="fa fa-check"></i> 10+ business analysts with 5-9 years of experience in the relevant fields.</li>
