...
<head>
    ...
    <!--====== Title ======-->
    <title>Best Mobile app application provider company in <?php echo $city; ?>.</title>
    <meta name="description" content="Camwel is the best mobile app service provider company in Patna. we create mobile apps of any complexity and size. ">
    <meta name="keywords" content=" Mobile apps development company, best mobile apps development company, Camwel mobile apps development company in Patna, mobile apps development company in Patna, mobile apps development company, mobile apps, mobile phone app development, mobile app, mobile, app.">
...
<body>
    <div class="page-wrapper">
        ...
        <!-- Page Banner Start -->
        <section class="page-banner bgs-cover overlay pt-50" style="background-image: url(assets/images/background/4.png);">
            <div class="container">
                <div class="banner-inner">
                    <h2 class="page-title">Mobile App Development</h2>
                </div>
            </div>
        </section>
        <!-- Page Banner End -->
        ...
        <section class="container" >
            <div class="row">
                <div class="col-md-6" style="margin-top:50px;">
                    <h3> <span class="under_line">Why</span> choose Camwel Solution LLP to create your app?</h3>
                    ...
                    <p class="bold">We have an experienced team, recognized for its achievements</p>
                    ...
                    <p class="bold">We’re a one-stop-shop for everything you need</p>
                    ...
                    <p class="bold">We create tailor-made applications for both iOS and Android</p>
                ...
                <div class="col-md-6">
                    ...
                    <img src="./assets/images/more/main_image.png" alt="">
                    <img src="./assets/images/services/mobile-app-development.png" alt="">
                </div>
            </div>
        ...
        <section class="container">
            <h3> <span class="under_line">We </span> deliver your projects on time and on budget</h3>
            <p class="text-justify">We pride ourselves on being honest and upfront with our quotes and sticking to budget. We also understand time pressures and do our utmost to complete projects within required deadlines.</p>
        </section>

        <section class="container" style="margin-top:55px;">
            <h3> <span class="under_line text-center">How </span> do we make it appliction?</h3>

            <div class="parant"> 
                <div class="item" style="max-width:350px; height:auto; padding:20px; background-color:rgb(22, 21, 21,0.1); box-shadow: 6px 6px rgb(156, 155, 155,0.4);">
                    <h4>Exploration</h4>
                ...
                <div class="item"style="max-width:350px; height:auto; padding:20px; background-color:rgb(22, 21, 21,0.1); box-shadow: 6px 6px rgb(156, 155, 155,0.4);">
                    <h4>Building an end-to-end solution</h4>
                    <p>Having completed the exploration stage, we start working on the UX and UI of your mobile app. We create wire frames which we share </p>
                </div>
        ...
        <section class="choose container" style="margin-top:55px;">
            <h3> <span class="under_line">What </span> are You Looking For ? </h3>

            <div class="row">
                <div class="col-md-6">
                    <ul>
                        <li></i>
                            <p class="bold"><i class="fa fa-hand-o-right"></i> Platform solutions</p>
                        ...
                        <li>
                            <p class="bold"><i class="fa fa-hand-o-right"></i> Solutions</p>
                ...
                <div class="col-md-6">
                    <img src="./assets/images/more/Mobile-App-Desing-and-Development.png" alt="">
                </div>
