...
<body>
    <div class="page-wrapper">
        ...
        <section class="page-banner bgs-cover overlay pt-50"
            style="background-image: url(assets/images/demo_image_1.jpg);">
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="contact-section-form px-15 rpx-0 rmb-50 wow fadeInUp delay-0-2s">
                                ...
                                <!-- test-1  -->
                                <form id="demo-form" action="demo_handler.php" class="contact-form" name="contact-form"
                                    method="post">
                                    <div class="row">
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select id="service" name="service" id="service">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <textarea name="comments" id="comments" maxlength="80"
                                    ...
                                    <div class="col-md-6 col-sm-12  mt-3">
                                        <input type="text" id="num" placeholder="Enter Captcha Here" class="set-sum"
                                           ...
                                           <div class="col-sm-12 mt-2">
                                            <button type="submit" name="demo_submit" class="theme-btn"
                                                onclick="return demoValidation()">Send Message</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
