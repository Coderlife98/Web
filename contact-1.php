...
<head>
    ...
    <meta name="keywords" content="Website development company in India, Microfinance billing software, Microfinance software minimum cost, Microfinance Software Companies, Multi branch microfinance software, Microfinance software high cost, No.1 software company in Patna, Best Microfinance software near me, Loan management software,Microfinance software">
...
<body>
    <div class="page-wrapper">
        ...
        <!-- Page Banner Start -->
        <section class="page-banner bgs-cover overlay pt-50" style="background-image: url(assets/images/more/contact_1.jpg);">
            <div class="container">
            ...
            <div class="container">
                <div class="contact-info-area mb-80">
                    ...
                    <div class="contact-info-item wow fadeInUp delay-0-6s">
                        ...
                        <p><a href="callto:9572852742">+91-9572852742</a> <br><a href="callto:9028388889">+91-9028388889</a></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-8">
                        <div class="contact-form ml-40 rml-0 rmt-55 wow fadeInRight delay-0-2s">
                            ...
                            <p>We’re eager to work with you. Please share your project goals and contact information. We respond to 97% of queries within 1-2 business days. Really!</p>
                            <form class="comment-form mt-35" id="contact_form" action="formhandler.php" method="post">
                                ...
                                <div class="row clearfix justify-content-center">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" name="name" class="form-control" value="" placeholder="Your Full Name" >
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="mobile" name="mobile" maxlength="10" pattern="[1-9]{1}[0-9]{9}" class="form-control" value="" placeholder="Your Mobile Number" >
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="location"><i class="fas fa-map"></i></label>
                                            <input type="text" id="location" name="location" class="form-control" value="" placeholder="Your location" >
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="comments"><i class="fas fa-pencil-alt"></i></label>
                                            <textarea name="message" id="message" class="form-control" rows="4" placeholder="Write Message" maxlength="150" ></textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input type="text" class="text-center" id="disabledInput" type="number" value=" <?php echo $n1; ?> + <?php echo $n2; ?> =" disabled style="color:black;font-weight:bolder">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input type="number" name="uanswer" id="uanswer" class="form-control" placeholder="?" required="required" data-error="Answer is required.">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group mb-0">
                                            <button type="submit" name="submit_contact" class="theme-btn" onclick=" return isValidation()">Send Message</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
var message=$('#message').val();
  ...
  {
    alert("Message must be max 100 letters *");
    $('#message').focus();
    return false; 
  }
...
return true;
        ...
        <div class="contact-page-map">
            <div class="our-location">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3598.3478440400727!2d85.17795211488385!3d25.59335518371349!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39ed58af9724643f%3A0x374894e117e7ef84!2sCamwel%20Corporate%20Solution%20Private%20Limited!5e0!3m2!1sen!2sin!4v1650629801589!5m2!1sen!2sin" height="650" style="border:0; width: 100%;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
        <!--======== Map =========-->
