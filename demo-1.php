...
<head>
    ...
    <!--====== Title ======-->
    <title>Demo | Microfinance software provider company in <?php echo $city; ?> </title>
    <meta name="description" content="Best microfinance Software  with account management, for Personal Loan, Corporate  Loan, Public  Loan  etc. Contact for live Software Demo.">
    <meta name="keywords" content="Microfinance software, Microfinance software provider company in India, Multi branch software provider in India, Microfinance  billing software, Loan management software, Best microfinance Software provider in Patna, Microfinance Software, Microfinance  Software Companies, in Bihar, Microfinance software cost">
...
<body>
    <div class="page-wrapper">
        ...
        <!-- Page Banner Start -->
        <section class="page-banner bgs-cover overlay pt-50" style="background-image: url(assets/images/demo_image_1.jpg);">
            <div class="container">
                <div class="banner-inner">
                    <h1 class="page-title">Free Demo</h1>
                </div>
            </div>
        </section>
        <!-- Page Banner End -->
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="contact-section-form px-15 rpx-0 rmb-50 wow fadeInUp delay-0-2s">
                                ...
                                <!-- test-1  -->
                                <form id="demo-form" class="contact-form" name="contact-form" action="formhandler.php" method="post" >
                                    <div class="row">
                                        <div class="col-sm-6">
                                           ...
                                           <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select id="service" name="service">
                                                    <option value="IT Consluting" selected>IT Consluting</option>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <textarea name="message" id="message" maxlength="20" class="form-control" rows="4" placeholder="Let us know what you need." ></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <input type="number" id="number" name="number" class="form-control" placeholder="?" data-error="Answer is required."  required="required">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <button type="submit" name="demo_submit" class="theme-btn" onclick="demoValidation()">Send Message</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <div class="contact-informations text-white">
                                    ...
                                    <ul class="contact-info">
                                        <li>
                                            ...
                                            <div class="content">
                                                <span>Call Us</span>
                                                <h5><a href="callto: 9572852742"> 9572852742, 9028388889</a></h5>
                                            </div>
                                        </li>
                                        <li>
