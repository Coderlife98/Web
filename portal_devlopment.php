...
<head>
    ...
    <!--====== Title ======-->
    <title>Best web portal development company in <?php echo $city; ?>.</title>
    <meta name="description" content="Camwel, In this internet driven world where business from all around the world use the internet as a medium to reach their clients and perform their business module in an interactive and efficient fashion.">
    <meta name="keywords" content=" Web portal development company, portal development company in Patna, portal service provider company, java development company, web, web portal, portal development, portal development in near me, Camwel portal development company in Patna.">
...
<body>
    <div class="page-wrapper">
        ...
        <!-- Page Banner Start -->
        <section class="page-banner bgs-cover overlay pt-50" style="background-image: url(assets/images/background/Portal\ Development.png);   background-position: center;  background-size: cover;">
            <div class="container">
                <div class="banner-inner">
                    <h2 class="page-title">Portal Development</h2>
                </div>
            </div>
        </section>
        <!-- Page Banner End -->

        <section class="mt intro container">
            <div class="row">
                <div class="col-md-6">
                    <h3> <span class="under_line">Portal</span> Development Services</h3>
                    <p class="text-justify">Camwel Solution LLP In this internet driven world where business from all around the world use the internet as a medium to reach their clients and perform their business module in an interactive and efficient fashion. Our technical team provides their technical excellence and aesthetic capabilities to great use in developing the most feature-rich and user-friendly web portals for our global clients. <br>Web portal development in appearance, structure, and functioning is the website that most often contains limited or personalized or Business and corporate enterprise portals. These Web Portals designed and developed by Camwel Solution LLP Designs helps to structure and feed the world with information relating to various different topics and media. Our offering includes its experience in Web Development and other website applications development, including the most exclusive web portal development for its client to enhance and help grow their business modules and structure their businesses with innovative and efficient portal solutions.</p>
                </div>
                <div class="col-md-6">
                    <img src="./assets/images/services/web-portal.png" alt="">
                </div>
            </div>

        </section>

        <section class="mt int1 container">
            <h3> <span class="under_line">Best </span> Web Portal Development Company</h3>
            <p class="text-justify">When the portal is the business, there is no compromising on the performance, cost-efficiency and growth potential of both. Camwel Solution LLP Designs has the skill set and the experience required to guarantee delivery of a reliable solution to win, serve and retain your customers.</p>
        </section>

        <section class="mt choose container">
            <h3> <span class="under_line"> Why </span> do you need web portal development Company </h3>

            <div class="row">
                <div class="col-md-6">
                    <ul>
                        <li><i class="fa fa-hand-o-right"></i> Do you want to manage the business from anywhere in the world?
                        </li>
                        <li><i class="fa fa-hand-o-right"></i>
                            Do you want a web portal development solution that caters to a specific industry niche?
                        </li>
                        <li><i class="fa fa-hand-o-right"></i>Do you want web portal development services that cater to your domain expertise but covers innumerable businesses and sectors?</li>
                        <li><i class="fa fa-hand-o-right"></i>You need a platform to disburse information and exchanges on a large scale?</li>
                        <li><i class="fa fa-hand-o-right"></i>Do you want a solution that is a coming together of diverse eCommerce functions/applications on a single website?</li>
                        <li><i class="fa fa-hand-o-right"></i>You are looking for full-fledged web portal development company with web enterprise solutions that are beyond the scope of an ordinary website?</li>
                        <li><i class="fa fa-hand-o-right"></i>Our web portal development facilitates security-rich and reliable user experience with single sign approach providing access to wide range of applications and content.</li>
                ...
                <div class="col-md-6">
                    <img src="./assets/images/services/Web-Portals.png" alt="">
                </div>

            </div>
        </section>

        <section class="mt feature container text-center">

            <h3><span>What</span> do we do in Web Portal & Development ?</h3>

            <div class="tab"> Real Estate Web Portal</div>
            <div class="tab">Education Web Portal </div>
            <div class="tab">Networking Web Portal </div>
            <div class="tab"> Government Web Portal</div>
            <div class="tab">E-Commerce Web Portal </div>
            <div class="tab">job Web Portal </div>
            <div class="tab"> Community Web Portal</div>
            <div class="tab">Service Web Portal </div>
        ...
        <section class="mt why container">
            <h3> <span class="under_line">Our</span> Portal Development Services:</h3>
            <ul>
                <li><i class="fa fa-hand-o-right"></i> Portal website design: modern, responsive user interface to offer.</li>
                <li><i class="fa fa-hand-o-right"></i> Migration: creating a new web portal that would fit your emerging needs and seamlessly inherit data (including content, interface, meta-data, and users) from the legacy system</li>
                <li><i class="fa fa-hand-o-right"></i> Maintenance and support:</li>
                <li><i class="fa fa-hand-o-right"></i> Scaling and high-load optimization</li>
                <li><i class="fa fa-hand-o-right"></i> Regular web portal updates to improve the functionality</li>
            </ul>
            <p class="bold text-justify">Camwel Solution LLP Offers other different services like SEO, SMO, Link building to your website, OpenCart , ZenCart Website Development, OsCommerce , Web Application Development, Cheap and Best Web hosting services, PPC</p>
        </section>
