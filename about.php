...
<head>
    ...
    <!--====== Title ======-->
    <title>About Us | Best microfinance software development company in <?php echo $city; ?></title>
    <meta name="description" content="Microfinance software helps manage the information related to Loan. Most powerful system includes Personal Loan, Corporate Loan, Public Loan etc.">
    <meta name="keywords" content="Microfinance loan management Software, Microfinance Software Provider near me, Microfinance Software in Patna, No.1 software company in Patna, Microfinance Billing Software, No.1 Microfinanace Software company in India, Best Microfinance Software in Patna, Microfinance software high cost, Best microfinance software development company in India, Microfinance Software low Cost">
...
<body>
    <div class="page-wrapper">
        ...
        <!-- Page Banner Start -->
        <section class="page-banner hi bgs-cover overlay pt-0" style="background-image: url(assets/images/banner.jpg);">
            <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="about-content pr-90 rpr-0 rmb-55 wow fadeInLeft delay-0-2s">
                            ...
                            <p style="color:#005055; font-size:16px; text-align: justify;">"Camwel Is a mutual benefit Company carrying on the business of a non-banking financial institution? Mutual Benefit Companies are Incorporated Under Indian Companies Act, 2013.".</p>
                            <p style="text-align: justify; font-size:16px;">It is a non banking financial company doing the business of lending and borrowing with Its members or shareholders. The government has set up law for the Security of the deposit in the Company to which the cradle is legally necessary.</p>
                            <p style="text-align: justify; font-size:16px;">To encourage and afford all facilities for cultivating thrift, savings habits and to Render all financial assistance to its members only by receiving long and short term Deposits and in particular recurring deposit and other deposits, not Being current accounts from the members as are allowed by law for Mutual Benefit.</p>
                            <p style="text-align: justify; font-size:16px;">In Camwel you can trust your dreams turning in to reality and living them by investing wisely. In order to help yours dream realized we are continuously trying to grow overselves and make presence felt even beyond geographical boundaries.</p>
                            <p style="text-align: justify; font-size:16px;"><strong>I hope we are committed for growth of our society and our members to you by rendering our best services.</strong></p>
                            <a href="contact.php" class="theme-btn mt-25">Call Now</a>
                        </div>
                    </div>
                    <div class="col-lg-5"  >
                        <div class="about-four-images text-center wow fadeInRight delay-0-2s">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <img class="bg-circle-dtos mb-35 d-block mx-auto" src="assets/images/logo/logo.png" alt="Logo">
