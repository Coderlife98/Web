...
<body>
    <div class="page-wrapper">
        ...
        <section class="page-banner bgs-cover overlay pt-50"
            style="background-image: url(assets/images/more/contact_1.jpg);">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="contact-form ml-40 rml-0 rmt-55 wow fadeInRight delay-0-2s">
                            ...
                            <form action="contact_formhandler.php" method="post" class="comment-form mt-35" id="contact_form"  >
                                   ...
                                   <div class="col-md-6 col-sm-12 mt-2">
                                    ...
                                    <div class="col-sm-12 mt-3">
                                        <div class="form-group mb-0">
                                            <button type="submit" id="submit" name="submit" class="theme-btn"
        ...
        <script>
            ...
            function isValidation() {
                ...
                if (lan <= 3) {
                    ...
                    alert("Message must be max 25 letters *");
                    $('#message').focus();
                    return false;
                } else if (!dued) {
